...
const BodyFormSection = ({ className = "" }) => {
  {
    /* Set state */
  }
  ...
  return (
    <section className={`body-section1 ${className}`}>
      <div className="body-header2">
        <h1 className="body-header-text4">Điền thông tin chứng chỉ của bạn</h1>
      </div>
      <form
