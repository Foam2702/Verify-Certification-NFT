...
const Exam = () => {
    ...
    useEffect(() => {
        const fetchExam = async () => {
            try {
                const result = await axios(`https://soulbound-token-nft-api.vercel.app/courses/course/${id}/exam`)
        ...
        const fetchCourse = async () => {
            try {
                const result = await axios(`https://soulbound-token-nft-api.vercel.app/courses/course/${id}`)
        ...
        const check = async () => {
            ...
            try {
                ...
                const result = await axios(`https://soulbound-token-nft-api.vercel.app/exam/${id}?address=${address}`)
                console.log(result)
