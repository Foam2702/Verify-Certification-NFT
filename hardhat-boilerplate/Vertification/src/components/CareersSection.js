  ...
  return (
    <main className="careers-section">
      ...
      <div className="career-11">
        ...
        <input className="input1" placeholder="Choose..." type="date" onChange={handleDateChange} />
      </div>
      ...
      <div className="career-5">
        ...
        <div className="apply-now">Apply Now</div>
        <input className="input1" placeholder="Choose..." type="date" />
      ...
      <div className="career-12">
        ...
        <input className="input8" placeholder="Choose..." type="date" />
      </div>
