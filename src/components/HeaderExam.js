...
const HeaderExam = () => {
    ...
    useEffect(() => {
        const fetchTickets = async () => {
            try {
                const allTickets = await axios("https://soulbound-token-nft-api.vercel.app/tickets/all");
                        ...
                        for (const ticket of allTickets.data.tickets) {
                            try {
                                ...
                                if (result.includes(address)) {
                                    const ticketFromOrg = await axios(`https://soulbound-token-nft-api.vercel.app/tickets/${ticket.licensing_authority}`);
