...
const EditExam = () => {
    ...
    const handleFileUpload = (event) => {
        ...
        reader.onload = (e) => {
            ...
            // setQuestions(transformedQuestions);
            setQuestions(existingQuestions => [...existingQuestions, ...transformedQuestions]);
        };
                                ...
                                <Accordion onChange={() => { handleExpand(i) }} expanded={questions[i].open}>
                                    ...
                                    <AccordionDetails>
                                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', marginLeft: '15px', marginTop: '-15px' }}>
                                            ...
                                            <Typography variant="body2" style={{ color: 'grey' }}>You can add maximum 4 options</Typography>
                                            <TextField
                                                fullWidth={true}
