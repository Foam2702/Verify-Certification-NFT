    ...
    useEffect(() => {
        const fetchUserInfo = async () => {
            try {
                if (address) {
                    console.log(address)
                    const response = await axios.get(`https://soulbound-token-nft-api.vercel.app/addresses/${address}`);
    ...
    const handleUpdateInfo = async (e) => {
        ...
        if (isPrivateKeyValid) {
            ...
            if (check) {
                ...
                const response = await axios.patch(`https://soulbound-token-nft-api.vercel.app/addresses/profile/${address}`, {
