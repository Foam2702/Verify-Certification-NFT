...
const CareersSection = () => {
  ...
  const onfileChange = (event) => {
    setFile('/home/bedaudau/Pictures/Screenshots/a.png');
  };
  const handleSubmit = async (event) => {
    ...
    const fileObj = new File([file], file.name); // Convert file path to file object
    ...
    <main className="careers-section">
      ...
      <div className="career-13">
        ...
        <div className="input9" >
          <div className="bg8" />
          <input className="enter" name ="imageCertificate" type="file" onChange={onfileChange} />
        </div>
      </div>
