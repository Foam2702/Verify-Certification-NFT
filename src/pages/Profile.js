                            ...
                            <div className="home-town">
                                ...
                                {/* {user && user.region ? (
                                    <input
                                        ...
                                        name="region"
                                        type="text"
                                        // defaultValue={privateKey ? decryptedRegion : minifyAddress(user.region)}
                                        defaultValue={(privateKey ? decryptedRegion : minifyAddress(user.region))}
                                    />
                                ) : (
                                ...
                                <input
                                    ...
                                    type="text"
                                    // defaultValue={privateKey ? decryptedRegion : minifyAddress(user.region)}
                                    defaultValue={(user && user.region) ? (privateKey ? decryptedRegion : minifyAddress(user.region)) : ''}
                                />
                            </div>
